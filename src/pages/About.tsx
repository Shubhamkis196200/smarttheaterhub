    ...
    <div>
      <section style={{ background: 'linear-gradient(135deg, #1a1a2e, #16213e)', color: '#fff', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container">
          <SEO title="About" description="Learn about SmartTheaterHub — your trusted source for home theater reviews, tools, and guides." path="/about" />
      ...
      <section className="section">
        <div className="container" style={{ maxWidth: 800 }}>
          ...
          <p style={{ fontSize: '1.05rem', lineHeight: 1.8, color: '#c4c8d0', marginBottom: '1.5rem' }}>
          ...
          <div className="grid-2" style={{ marginBottom: '2rem' }}>
            {[
              ...
              <div key={item.title} className="card">
                ...
                <p style={{ fontSize: '0.85rem', color: '#9ca3af' }}>{item.desc}</p>
              </div>
            ))}
          </div>
